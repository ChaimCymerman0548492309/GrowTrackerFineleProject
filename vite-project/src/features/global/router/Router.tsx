...
import AddGardenPage from '../../gardens/pages/AddGardenPage/AddGardenPage';
import AddUserPage from '../../users/pages/AddUserPage/AddUserPage';
import UpDateGardene from '../../gardens/pages/upDateGardene/upDateGardene';
import AllUsersPage from '../../users/pages/allUers/AllUsersPage';
import ViewUserPage from '../../users/pages/userPage/userPage';
        ...
        <>
            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path='/AllGardens' element={<AllGardens />} />
                    <Route path='/AddGardenPage' element={<AddGardenPage/>} />
                    <Route path='/AddUserPage' element={<AddUserPage/>} />
                    <Route path='/UpDateGardene' element={<UpDateGardene/>} />
                    <Route path='/AllUsersPage' element={<AllUsersPage/>} />
                    <Route path='/ViewUserPage/:id' element={<ViewUserPage/>} />
